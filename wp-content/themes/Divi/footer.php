	<footer id="main-footer">
		...
		<div id="footer-bottom">
			<div class="container clearfix">
				...
				<p id="footer-info"><?php printf( __( 'Powered by %1$s | Build on %2$s', 'Divi' ), '<a href="http://www.hiretspace.com" title="An Open Source Energizer">HiretSpace</a>', '<a href="http://www.wordpress.org">WordPress</a>' ); ?></p>
			</div>	<!-- .container -->
		</div>
	</footer> <!-- #main-footer -->
